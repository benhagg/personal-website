...
const workExperiences = [
  {
    ...
    responsibilities: [
      "Redesigned cloud architecture using Docker, Terraform, and AWS (EB, EC2, VPC, IAM, Amplify, Cognito), improving reliability and reducing infrastructure costs by 50%.",
  ...
  },
  {
    ...
    responsibilities: [
      "Worked with founders to design a relational database schema for scalability and migrated a NoSQL DynamoDB database to an AWS RDS MySQL instance, using Python scripts for data ETL.",
    ],
  },
  {
    company: "BYU AC Shop",
